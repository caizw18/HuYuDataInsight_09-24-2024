...
# Fetch JPMorgan Chase's current stock price
ticker = 'JPM'
data = yf.Ticker(ticker)
current_price = data.history(period='1d')['Close'].iloc[-1]

# Parameters for the Black-Scholes model
S = current_price  # Current stock price of JPMorgan Chase (JPM)
...
sigma = 0.28  # Volatility of the stock price (e.g., 28%)
...
# Print the results
print(f"JPMorgan Chase (JPM) Current Stock Price: {S:.2f}")
...
# JPMorgan Chase (JPM) Current Stock Price: 157.89
# Strike Price: 150
# Time to Expiration (years): 1.10
# Risk-Free Interest Rate: 0.05
# Volatility: 0.28
# Call Option Price: 13.56
# Put Option Price: 6.78